...
build/testNN: build/nn.o build/layer.o build/connection.o build/matrix.o build/vector.o build/nnTest.o
	$(LINK) build/nn.o build/layer.o build/connection.o build/matrix.o build/vector.o build/nnTest.o -o build/testNN
	./build/testNN
